...
**A computational framework for comparative predictive modeling of gene expression using single-cell multiomics data**
...
source("combined/install_packages.R")
```
...
| | `scvi` | scVI variational autoencoder |
| `atac_only/` | `lsi` | Latent Semantic Indexing |
| | `peakvi` | PeakVI variational autoencoder |
...
|---------|-------------|---------|---------------|
| E7.5_rep1 | Mouse embryo E7.5 (replicate 1) | *Mus musculus* | `GSExxxxxxx` |
| E7.5_rep2 | Mouse embryo E7.5 (replicate 2) | *Mus musculus* | `GSExxxxxxx` |
| T_Cells | PBMC T cells (subset from 10x PBMC 10k) | *Homo sapiens* | [10x Genomics](https://www.10xgenomics.com/datasets/pbmc-from-a-healthy-donor-granulocytes-removed-through-cell-sorting-10-k-1-standard-2-0-0) |
...
For questions, bug reports, or feature requests, please open an issue on the [GitHub repository](https://github.com/yourusername/scMultiPreDICT/issues).
