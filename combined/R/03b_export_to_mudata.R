...
# ============================================================================
# This script converts the Seurat object from Step_020 to MuData (.h5mu) format
# so it can be used by the Python autoencoder script (train_autoencoder.py).
#
# Input: Seurat RDS file from Step_020
...
cat("\n")
cat("=", rep("=", 70), "\n", sep = "")
cat("STEP 03b: Export Seurat to MuData Format\n")
cat("=", rep("=", 70), "\n\n", sep = "")
...
Auto-generated by Step_03b_export_to_mudata.R
"""
import os
import scipy.io
import pandas as pd
...
print("=" * 80)
print(f"\\nNext step: Run train_autoencoder.py with:")
print(f"  python train_autoencoder.py \\\\")
...
cat("\nNext step: Run train_autoencoder \n")
