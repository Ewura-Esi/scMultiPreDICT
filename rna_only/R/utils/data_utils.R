# ============================================================================
# scMultiPreDICT - Data Utilities (RNA-only Pipeline)
# ============================================================================
# Reusable functions for RNA-only data loading, splitting, and preprocessing
#
# Usage:
#   source("R/utils/data_utils.R")
# ============================================================================

#' Load 10X Genomics scRNA-seq data into a Seurat object
#'
...
#' @return Seurat object with RNA assay
#' @export
load_rna_data <- function(mtx_path, features_path, barcodes_path,
                          project_name = "scrna") {
  ...
  cat(sprintf("\n✓ Created Seurat object: %d cells, %d genes\n", 
...
#' Apply quality control filters to RNA data
#'
...
#' @param min_count_rna Minimum UMI counts per cell
#' @param max_count_rna Maximum UMI counts per cell
